...
public class MainActivity extends ActionBarActivity {
    ...
    private static final String DEFAULT_POLLING_INTERVAL = "15";
            ...
            protected void onPostExecute(final Object obj) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        setStatusText(opms.txt, opms.status);
                    }
                });
            }
        };
    ...
    private void setStatusText(String txt, Status status) {
        ...
        statusPhrase.setText(status.toString());
    ...
    public enum Status {Open, Alert, Closed}
}
